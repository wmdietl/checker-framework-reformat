...
public class KeyForAnnotatedTypeFactory
    ...
    */
    ...
    private LinkedHashSet<String> canonicalizeKeyForValues(
        ...
        if (anno != null) {
            ...
            boolean valuesChanged =
                    false; // Indicates that at least one value was changed in the list.
            ...
            for (String s : values) {
                ...
                if (unknownReceiver // The receiver type was unknown initially, and ...
                    ...
                    try {
                        ...
                        varTypeReceiver =
                                FlowExpressionParseUtil.parse("this." + s, flowExprContext, path);
                    } catch (FlowExpressionParseException e) {
    ...
    private AnnotationMirror canonicalizeKeyForValuesGetAnnotationMirror(
            AnnotationMirror anno, FlowExpressionContext flowExprContext, TreePath path, Tree t) {
        LinkedHashSet<String> newValues =
                canonicalizeKeyForValues(anno, flowExprContext, path, t, true);

        return newValues == null ? null : createKeyForAnnotationMirrorWithValue(newValues);
    }

    private void canonicalizeKeyForValues(
            AnnotatedTypeMirror atm, FlowExpressionContext flowExprContext, TreePath path, Tree t) {

        AnnotationMirror anno =
                canonicalizeKeyForValuesGetAnnotationMirror(
                        atm.getAnnotation(KeyFor.class), flowExprContext, path, t);
    ...
    private void keyForCanonicalizeValuesForMethodCall(
        ...
        if (varType != null) {
            FlowExpressionContext flowExprContextVarType =
                    node instanceof MethodInvocationNode
                            ...
                            : FlowExpressionParseUtil.buildFlowExprContextForUse(
                                    (ObjectCreationNode) node, path, getContext());
            ...
            if (enclosingMethod != null) {
                ...
                for (VariableTree vt : enclosingMethod.getParameters()) {
                    internalArguments.add(
                            FlowExpressions.internalReprOf(
                                    this, new LocalVariableNode(vt, receiver)));
                }
                ...
                flowExprContextValueType =
                        new FlowExpressionContext(
                                internalReceiver, internalArguments, getContext());
            } else {
    ...
    public boolean keyForValuesSubtypeCheck(
        ...
        LinkedHashSet<String> var =
                canonicalizeKeyForValues(varType, flowExprContextVarType, path, t, false);
            ...
            if (node instanceof MethodInvocationNode || node instanceof ObjectCreationNode) {
                ...
                if (enclosingMethod != null) {
                    ...
                    if (enclosingMethod.getModifiers().getFlags().contains(Modifier.STATIC)) {
                        ...
                        receiver =
                                new ImplicitThisLiteralNode(InternalUtils.typeOf(enclosingClass));
                    }
                ...
                FlowExpressionContext flowExprContext =
                        new FlowExpressionContext(r, internalArguments, getContext());
        ...
        protected List<AnnotatedTypeMirror> getArgumentTypes(
            ...
            if (!argTypes.isEmpty()) {
                ...
                FlowExpressionContext flowExpressionContext =
                        FlowExpressionParseUtil.buildFlowExprContextForViewpointUse(
                                node, pathToInvocation, enclosingMethodPath, getContext());

                for (AnnotatedTypeMirror argType : argTypes) {
                    keyForCanonicalizer.canonicalize(
                            argType, flowExpressionContext, pathToInvocation, expression);
                }
            }
    ...
    public void canonicalizeForViewpointAdaptation(
        ...
        FlowExpressionContext flowExpressionContext =
                FlowExpressionParseUtil.buildFlowExprContextForViewpointUse(
                        node, path, enclosingMethodPath, getContext());
