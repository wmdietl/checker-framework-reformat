 ...
 * qualifier used for the type-system at hand, and is often called {@code MonoT}
 ...
 * target type {@code T}. This means that an expression of the monotonic type
 * {@code MonoT} cannot be assigned to a variable of the same type.
 *
 * <p>
 * Reading an expression of a monotonic type {@code MonoT} might always yield an
 * expression of type {@code S}. However, once it has been observed that a
 * variable has the target type {@code T}, the monotonic property ensures that
 * it will stay of type {@code T} for the rest of the program execution. This is
