...
class QualifiedTypeFactoryAdapter<Q> extends BaseAnnotatedTypeFactory {
    ...
    public QualifiedTypeFactoryAdapter(
            QualifiedTypeFactory<Q> underlying, CheckerAdapter<Q> checker) {
        super(checker, true);
    ...
    protected org.checkerframework.framework.type.TypeHierarchy createTypeHierarchy() {
        ...
        TypeHierarchyAdapter<Q> adapter =
                new TypeHierarchyAdapter<Q>(
                        underlyingHierarchy,
                        getCheckerAdapter().getTypeMirrorConverter(),
                        getCheckerAdapter(),
    ...
    protected org.checkerframework.framework.type.treeannotator.TreeAnnotator
        ...
        TreeAnnotatorAdapter<Q> adapter =
                new TreeAnnotatorAdapter<Q>(
                        underlyingAnnotator, getCheckerAdapter().getTypeMirrorConverter(), this);
    ...
    protected org.checkerframework.framework.type.typeannotator.TypeAnnotator
        ...
        TypeAnnotatorAdapter<Q> adapter =
                new TypeAnnotatorAdapter<Q>(
                        underlyingAnnotator, getCheckerAdapter().getTypeMirrorConverter(), this);
    ...
    public AnnotatedTypeMirror getAnnotatedType(Element elt) {
        return getCheckerAdapter()
                ...
                .getAnnotatedType(underlying.getQualifiedType(elt));
    }
    ...
    public AnnotatedTypeMirror getAnnotatedType(Tree tree) {
        return getCheckerAdapter()
                .getTypeMirrorConverter()
                .getAnnotatedType(underlying.getQualifiedType(tree));
    }
    ...
    public AnnotatedTypeMirror getAnnotatedTypeFromTypeTree(Tree tree) {
        return getCheckerAdapter()
                .getTypeMirrorConverter()
                .getAnnotatedType(underlying.getQualifiedTypeFromTypeTree(tree));
    }
    ...
    @Override
    public void postDirectSuperTypes(
            AnnotatedTypeMirror subtype, List<? extends AnnotatedTypeMirror> supertypes) {
        ...
        List<QualifiedTypeMirror<Q>> qualResult =
                underlying.postDirectSuperTypes(qualSubtype, qualSupertypes);
    ...
    List<QualifiedTypeMirror<Q>> superPostDirectSuperTypes(
    ...
    public void postAsMemberOf(
        ...
        QualifiedTypeMirror<Q> qualResult =
                underlying.postAsMemberOf(qualMemberType, qualReceiverType, memberElement);
    ...
    public Pair<AnnotatedExecutableType, List<AnnotatedTypeMirror>> methodFromUse(
        ...
        Pair<AnnotatedExecutableType, List<AnnotatedTypeMirror>> annoResult =
                Pair.of(
                        (AnnotatedExecutableType) conv.getAnnotatedType(qualResult.first),
                        conv.getAnnotatedTypeList(qualResult.second));

        return annoResult;
    }

    Pair<QualifiedExecutableType<Q>, List<QualifiedTypeMirror<Q>>> superMethodFromUse(
            MethodInvocationTree tree) {
        Pair<AnnotatedExecutableType, List<AnnotatedTypeMirror>> annoResult =
        ...
        Pair<QualifiedExecutableType<Q>, List<QualifiedTypeMirror<Q>>> qualResult =
                Pair.of(
                        (QualifiedExecutableType<Q>) conv.getQualifiedType(annoResult.first),
    ...
    public CFTransfer createFlowTransferFunction(
        ...
        return new QualTransferAdapter<>(
                qualAnalysis.createTransferFunction(), analysis, qualAnalysis);
    }
    ...
    protected TypeVariableSubstitutorAdapter<Q> createTypeVariableSubstitutor() {
        ...
        TypeVariableSubstitutorAdapter<Q> adapter =
                new TypeVariableSubstitutorAdapter<Q>(
                        substitutor, this.getCheckerAdapter().getTypeMirrorConverter());
