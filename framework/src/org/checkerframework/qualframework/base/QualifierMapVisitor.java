...
public abstract class QualifierMapVisitor<Q, R, P>
    ...
    private List<QualifiedTypeMirror<R>> visitTypes(
            List<? extends QualifiedTypeMirror<Q>> types, P p) {
    ...
    private List<QualifiedParameterDeclaration<R>> visitTypeParameters(
            List<? extends QualifiedParameterDeclaration<Q>> types, P p) {
    ...
    public QualifiedTypeMirror<R> visitArray(QualifiedArrayType<Q> type, P p) {
        return new QualifiedArrayType<R>(
    ...
    public QualifiedTypeMirror<R> visitDeclared(QualifiedDeclaredType<Q> type, P p) {
        return new QualifiedDeclaredType<R>(
                type.getUnderlyingType(),
                process(type.getQualifier(), p),
    ...
    public QualifiedTypeMirror<R> visitExecutable(QualifiedExecutableType<Q> type, P p) {
        return new QualifiedExecutableType<R>(
                type.getUnderlyingType(),
    ...
    public QualifiedTypeMirror<R> visitIntersection(QualifiedIntersectionType<Q> type, P p) {
        return new QualifiedIntersectionType<R>(
                type.getUnderlyingType(),
                process(type.getQualifier(), p),
    ...
    public QualifiedTypeMirror<R> visitNoType(QualifiedNoType<Q> type, P p) {
        return new QualifiedNoType<R>(type.getUnderlyingType(), process(type.getQualifier(), p));
    }

    @Override
    public QualifiedTypeMirror<R> visitNull(QualifiedNullType<Q> type, P p) {
        return new QualifiedNullType<R>(type.getUnderlyingType(), process(type.getQualifier(), p));
    }

    @Override
    public QualifiedTypeMirror<R> visitPrimitive(QualifiedPrimitiveType<Q> type, P p) {
        return new QualifiedPrimitiveType<R>(
                type.getUnderlyingType(), process(type.getQualifier(), p));
    }

    @Override
    public QualifiedTypeMirror<R> visitTypeVariable(QualifiedTypeVariable<Q> type, P p) {
        return new QualifiedTypeVariable<R>(
                type.getUnderlyingType(), process(type.getQualifier(), p));
    }

    @Override
    public QualifiedTypeMirror<R> visitUnion(QualifiedUnionType<Q> type, P p) {
        return new QualifiedUnionType<R>(
                type.getUnderlyingType(),
                process(type.getQualifier(), p),
    ...
    public QualifiedTypeMirror<R> visitWildcard(QualifiedWildcardType<Q> type, P p) {
        return new QualifiedWildcardType<R>(
                type.getUnderlyingType(),
    ...
    public QualifiedTypeMirror<R> visitTypeDeclaration(QualifiedTypeDeclaration<Q> type, P p) {
        return new QualifiedTypeDeclaration<R>(
                type.getUnderlyingType(),
                process(type.getQualifier(), p),
                visitTypeParameters(type.getTypeParameters(), p));
    }
    ...
    @Override
    public QualifiedTypeMirror<R> visitParameterDeclaration(
            QualifiedParameterDeclaration<Q> type, P p) {
